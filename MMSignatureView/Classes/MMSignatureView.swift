//
//  MMSignatureView.swift
//  MMSignatureView
//
//  Created by Mohammed Mir on 21/03/2020.
//
...
@IBDesignable
final public class MMSignatureView: UIView {
    
    public weak var delegate: MMSignatureViewDelegate?
    
    // MARK: - Public properties
    @IBInspectable public var strokeWidth: CGFloat = 4.0 {
        didSet {
    ...
    /// MMSignatureView.swift source file by intention.
    func injectBezierPath(_ path: UIBezierPath) {
        self.path = path
    }
}

// MARK: - Protocol definition for MMSignatureViewDelegate
/// ## MMSignatureViewDelegate Protocol

@objc
public protocol MMSignatureViewDelegate: class {
    func didStart(_ view : MMSignatureView)
    func didFinish(_ view : MMSignatureView)
}

extension MMSignatureViewDelegate {
    func didStart(_ view : MMSignatureView) {}
    func didFinish(_ view : MMSignatureView) {}
}
